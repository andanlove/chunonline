    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=20, verbose_name='城市信息')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cours_nums', models.IntegerField(default=0, verbose_name='课程数')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_company', models.CharField(max_length=50, verbose_name='入职公司')),
                ('work_position', models.CharField(max_length=50, verbose_name='公司职位')),
                ('points', models.CharField(max_length=50, verbose_name='教学特点')),
                ('click_nums', models.IntegerField(default=0, verbose_name='点击人数')),
                ('age', models.IntegerField(blank=True, default=0, null=True, verbose_name='教师年龄')),
                ('image', models.ImageField(blank=True, null=True, upload_to='Tea/%Y/%m', verbose_name='头像')),
